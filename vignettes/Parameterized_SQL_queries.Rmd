...
The package [RODBCext](http://cran.r-project.org/package=RODBCext)
is an extension of the
[RODBC](http://cran.r-project.org/package=RODBC) database 
...
vignette](http://cran.r-project.org/web/packages/RODBC/vignettes/RODBC.pdf)
...
An excellent example is [dplyr](http://cran.r-project.org/package=dplyr), 
...
[RODBC](http://cran.r-project.org/package=RODBC) package which deal with 
...
I hope [dplyr](http://cran.r-project.org/package=dplyr) developers will 
...
support on the top of the [RODBC](http://cran.r-project.org/package=RODBC)
...
[RODBC's](http://cran.r-project.org/package=RODBC) `sqlGetResults()`.
