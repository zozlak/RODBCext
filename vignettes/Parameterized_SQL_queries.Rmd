...
The package [RODBCext](http://cran.r-project.org/web/packages/RODBCext)
is an extension of the
[RODBC](http://cran.r-project.org/web/packages/RODBC) database 
...
An excellent example is [dplyr](http://cran.r-project.org/web/packages/dplyr), 
...
[RODBC](http://cran.r-project.org/web/packages/RODBC) package which deal with 
...
I hope [dplyr](http://cran.r-project.org/web/packages/dplyr) developers will 
